  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: transactionsAsync.when(
        ...
        data: (allTx) {
          // Performance optimization: Combine multiple filter criteria into a single pass.
          // This avoids unnecessary intermediate list allocations and repeated iterations.
