...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: transactionsAsync.when(
        ...
        data: (allTx) {
          // PERFORMANCE: Single pass filtering to avoid chained .where() and unnecessary list allocations
  ...
  Map<String, List<TransactionModel>> _groupByDate(
    ...
    // PERFORMANCE: Cache DateFormat instance outside loop to avoid expensive repetitive instantiations
    final format = DateFormat('yyyy-MM-dd');
    final Map<String, List<TransactionModel>> groups = {};
    for (final t in transactions) {
      final key = format.format(t.date);
