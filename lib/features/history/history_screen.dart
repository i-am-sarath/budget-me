  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: transactionsAsync.when(
        ...
        data: (allTx) {
          // Optimize filtering: Single pass through transactions instead of chained where()
          // This avoids creating multiple intermediate lists and iterating multiple times.
