...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Map<String, List<TransactionModel>> _groupByDate(
    ...
    // OPTIMIZATION: Cache DateFormat instance outside the loop to avoid repeated
    // expensive creation and parsing on every iteration, improving list rendering performance.
