    ...
    return Scaffold(
      ...
      body: transactionsAsync.when(
        ...
        data: (allTx) {
          ...
          // Using a single pass where() instead of chained where().toList()
          // improves performance by preventing multiple iterations over the list
          // and avoiding the creation of unnecessary intermediate list copies.
