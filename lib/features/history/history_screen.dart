...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: transactionsAsync.when(
        ...
        data: (allTx) {
          // Optimized: Single-pass filtering replaces chained .where() calls to avoid multiple iterations and list allocations.
  ...
  Map<String, List<TransactionModel>> _groupByDate(
    ...
    // Optimized: Cache DateFormat instance outside the loop to avoid repeated instantiation overhead.
