...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: transactionsAsync.when(
        ...
        data: (allTx) {
          // ⚡ Bolt Optimization: Use a single-pass loop instead of chained .where().toList()
          // to reduce multiple list iterations and intermediate object allocations.
  ...
  Map<String, List<TransactionModel>> _groupByDate(
    ...
    // ⚡ Bolt Optimization: Cache DateFormat instance outside the loop to avoid expensive
    // parsing and instantiation on every transaction.
