...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  Map<String, List<TransactionModel>> _groupByDate(
    ...
    // Performance optimization: Cache DateFormat outside the loop to prevent expensive
    // instantiations during list iteration, improving rendering speed for large transaction histories.
