...
extension AccountTypeX on AccountType {
  ...
  String get hint {
    switch (this) {
      case AccountType.bank:
        return 'Checking, savings, etc.';
      case AccountType.cash:
        return 'Physical cash on hand';
      case AccountType.loan:
        return 'Personal / car / home loan';
      case AccountType.creditCard:
        return 'Credit card balance owed';
      case AccountType.wallet:
        return 'PayPal, Apple Pay, etc.';
      case AccountType.mobilePay:
        return 'GCash, Pix, M-Pesa, etc.';
    }
  }
...
class AccountModel {
  ...
  factory AccountModel.fromMap(Map<String, dynamic> map) => AccountModel(
    ...
    iconCode:
        map['icon_code'] as int? ?? Icons.account_balance_rounded.codePoint,
