...
class SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Performance Optimization: Using a single-pass loop instead of multiple
    // .where().fold() chains avoids iterating over the transactions list multiple
    // times and reduces intermediate Iterable allocations.
    double expense = 0.0;
    double income = 0.0;
    double invested = 0.0;
    ...
    for (final t in transactions) {
      // Calculate all-time running totals
