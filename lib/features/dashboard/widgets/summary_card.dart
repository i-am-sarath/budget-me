...
class SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ⚡ Bolt: Using a single-pass loop to calculate transaction summaries
    // This avoids multiple O(N) traversals through the transactions list,
    // making rendering noticeably faster for users with large history.
    double expense = 0.0;
    double income = 0.0;
    double invested = 0.0;
    ...
    for (final t in transactions) {
      ...
      // All-time stats for lent/borrowed
