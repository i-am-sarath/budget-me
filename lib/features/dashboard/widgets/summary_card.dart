...
class SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // with a single pass loop. This reduces the time complexity from O(N*M)
    // to O(N) by iterating through the transaction list only once instead
    // of multiple times for each transaction type filtering.
    double expense = 0.0;
    double income = 0.0;
    double invested = 0.0;
