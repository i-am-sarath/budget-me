...
class SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Performance optimization: Single-pass iteration to calculate all
    // transaction metrics instead of using 7 separate .where().fold() chains.
    // This reduces O(7N) complexity to O(N) over the transactions list.
    double expense = 0.0;
    double income = 0.0;
    double invested = 0.0;
    ...
    for (final t in transactions) {
      ...
      switch (t.type) {
        ...
        case TransactionType.investment:
          if (isThisMonth) invested += t.amount;
          break;
