...
class SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Performance Optimization: Replace multiple .where().fold() chains with a single loop.
    // This reduces the time complexity from O(7N) to O(N) when generating the summary card.
    double expense = 0.0;
    double income = 0.0;
    double invested = 0.0;
