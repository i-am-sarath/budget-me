...
class _BalanceHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Replaced multiple .where().fold() chains with a single pass loop over the transactions.
    // This reduces the complexity from O(N * M) (where N is list size, M is number of filters) to O(N).
    double income = 0.0;
    double expense = 0.0;
    double balance = 0.0;
