      ...
      slivers: [
        ...
        SliverPadding(
          ...
          sliver: transactionsAsync.when(
            loading: () =>
                const SliverToBoxAdapter(child: _TransactionsSkeleton()),
            ...
            data: (txs) {
              ...
              // ⚡ Bolt: Used SliverChildBuilderDelegate instead of Column for lazy loading
              return SliverList(
                delegate: SliverChildBuilderDelegate((context, i) {
                  final e = filtered[i];
                  // Removed i * 30ms delay so lazy-loaded items appear instantly when scrolling
                  return GestureDetector(
                    onTap: () => showModalBottomSheet(
                      context: context,
                      isScrollControlled: true,
                      backgroundColor: Colors.transparent,
                      builder: (_) => ManualEntrySheet(prefill: e),
                    ),
                    child: TransactionTile(transaction: e, currency: currency)
                        .animate()
