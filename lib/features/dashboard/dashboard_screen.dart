...
class _BalanceHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Performance Optimization: Replaced multiple Iterable.where().fold() chains
    // with a single-pass loop to calculate income, expense, and balance.
    // This reduces the time complexity from O(3N) to O(N) when iterating over transactions.
    double income = 0.0;
    double expense = 0.0;
    double balance = 0.0;
